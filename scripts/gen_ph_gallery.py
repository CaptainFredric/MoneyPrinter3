...
Theme: logo palette — deep indigo background, purple circle, gold gem, sparkles.
...
# ── Brand palette (ContentForge logo theme) ──────────────────────────────────
BG_DEEP   = "#09063A"   # deepest navy
BG_MID    = "#12107A"   # mid indigo (gradient end)
BG_CARD   = "#1A166B"   # card surface
BG_CARD2  = "#211D7E"   # slightly lighter card
PURPLE    = "#4A3EC0"   # logo circle / badge
GOLD      = "#F5A623"   # logo gold / gem
GOLD2     = "#E8821A"   # gem shadow / secondary gold
WHITE     = "#FFFFFF"
TEXT_SUB  = "#C8C4FF"   # lavender-white subtitle
TEXT_BODY = "#8B85CC"   # muted body
TEXT_DIM  = "#4A448A"   # very dim / labels
BORDER    = "#2E2A8A"   # card border
SCORE_OK  = "#F5A623"
SCORE_MID = "#BDB6FF"
SCORE_BAD = "#FF6B6B"
...
def make_score_demo():
    ...
    for col, text in feedback:
        ...
        draw.text((366, fy+18), text, font=_font(17), fill=col, anchor="lm")
        fy += 46
