# ContentForge — Terms of Use

Effective date: March 28, 2026

This Terms of Use document ("Terms") governs your access to and use of the ContentForge API and related services (the "Service"). By accessing or using the Service — whether directly, through RapidAPI, or through an integrated product — you agree to be bound by these Terms.

This version is formatted for site or marketplace "Terms of Use" pages and is suitable to paste into RapidAPI's Terms field. It is a template only and does not constitute legal advice; please have counsel review before publishing.

## 1. Scope
These Terms apply to all use of the API endpoints and services operated by the Provider, including but not limited to `/v1/analyze_headline`, `/v1/generate_hooks`, `/v1/rewrite`, `/v1/tweet_ideas`, and `/health`.
...
## 4. Acceptable Use
You must not use the Service for unlawful activity or to generate content that is illegal, infringing, defamatory, abusive, pornographic, violent, or promotes hatred. You also must not use the Service to send spam, scrape protected content, or otherwise abuse third-party platforms.

Provider may suspend or terminate access for violations of this section or any actions that harm the Service or other users.

## 5. Rate Limits and Quotas
Your subscription plan defines rate limits and quotas. Exceeding limits may result in throttling, temporary blocks, or required plan upgrades. Provider reserves the right to modify limits to protect the Service.

## 6. AI-Generated Output
AI-generated content may be inaccurate, biased, or otherwise unsuitable for some uses. You are responsible for verifying, moderating, and disclaiming AI-generated content where appropriate. Do not use the Service for safety-critical systems.
...
TO THE MAXIMUM EXTENT PERMITTED BY LAW, PROVIDER WILL NOT BE LIABLE FOR INDIRECT, INCIDENTAL, SPECIAL, EXEMPLARY, OR CONSEQUENTIAL DAMAGES, OR FOR LOSS OF PROFITS, REVENUE, OR DATA, ARISING FROM YOUR USE OF THE SERVICE.
